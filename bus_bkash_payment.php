...
if (!isset($_SESSION['user_id'])) {
    if (!isset($_SESSION['redirect_to'])) {
        $_SESSION['redirect_to'] = 'bus_bkash_payment.php';
    }
...
<head>
    ...
    <title>bKash Payment - Mass Transport Ticketing System</title>
    ...
    <style>
        ...
        .card {
            ...
            background: #ffffff; /* bKash white background */
            border-radius: 10px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
            border: 1px solid #d8232a; /* bKash red border */
        ...
        .card:hover {
            ...
            box-shadow: 0 0 30px rgba(216, 35, 42, 0.4); /* bKash red shadow */
        }
        ...
        .btn-primary {
            background-color: #d8232a; /* bKash red button */
            border-color: #d8232a;
