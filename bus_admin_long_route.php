...
<head>
    ...
    grid-template-columns: repeat(20, 1fr); /* 20 seats per row */
    gap: 8px;
    margin-top: 20px;
...
.bus-row {
    ...
    margin-bottom: 5px; /* Reduced from 10px to decrease vertical spacing */
}

.bus-side {
    display: flex;
    gap: 3px; /* Small gap between adjacent seats */
}
