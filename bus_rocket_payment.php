...
if (!isset($_SESSION['user_id'])) {
    if (!isset($_SESSION['redirect_to'])) {
        $_SESSION['redirect_to'] = 'bus_rocket_payment.php';
    }
...
<head>
    ...
    <title>Rocket Payment - Mass Transport Ticketing System</title>
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <form id="paymentForm" method="POST" action="bus_payment_process.php">
                    ...
                    <div class="form-group">
                        <label for="rocket_pin">Rocket PIN:</label>
                    ...
                    <button type="submit" class="btn btn-primary">Pay with Rocket</button>
                </form>
            </div>
        </div>
    </div>
